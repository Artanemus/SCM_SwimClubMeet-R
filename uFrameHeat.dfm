object FrameHeat: TFrameHeat
  ...
  object pnlStack: TStackPanel
    ...
    object spbtnHeatAutoBuild: TSpeedButton
      ...
      Height = 48
      Hint = 
        'Auto-build heats. Raced and closed heats are excluded from build' +
        '.'
      Anchors = []
      ImageIndex = 5
      ImageName = 'build'
  ...
  object actnHeatList: TActionList
    ...
    object actnHeat_AutoBuild: TAction
      Category = 'Heat'
      Hint = 
        'Auto-build heats. Raced and closed heats are excluded from build' +
        '.'
      OnExecute = actnHeat_AutoBuildExecute
      OnUpdate = actnHeat_DefaultUpdate
    end
    object actnHeat_MarshallSheet: TAction
      Category = 'Heat'
      Hint = 'Display a marshall'#39's sheet for all heats.'
      OnExecute = actnHeat_MarshallSheetExecute
      OnUpdate = actnHeat_ReportUpdate
    end
    object actnHeat_TimeKeeperSheet: TAction
      Category = 'Heat'
      Caption = 'Action1'
      Hint = 'Display a timekeeper'#39's sheet for the selected heat.'
      OnExecute = actnHeat_TimeKeeperSheetExecute
      OnUpdate = actnHeat_ReportUpdate
    end
    object actnHeat_PrintSheets: TAction
      Category = 'Heat'
      Hint = 'Print all sheets (marshall and timekeepers).'
      OnExecute = actnHeat_PrintSheetsExecute
      OnUpdate = actnHeat_ReportUpdate
    end
    object actnHeat_Report: TAction
      Category = 'Heat'
      Hint = 'Display a heat report. (CTRL-LMB for alternate report.)'
